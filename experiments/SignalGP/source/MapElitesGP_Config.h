...
EMP_BUILD_CONFIG( MapElitesGPConfig,
  ...
  VALUE(USE_MAPE_AXIS__FUNC_USED, bool, false, "Should we use functions used as a MAP-Elites axis?"),
  VALUE(USE_MAPE_AXIS__FUNC_CNT, bool, true, "Should we use function count as a MAP-Elites axis?"),
  VALUE(USE_MAPE_AXIS__FUNC_ENTERED, bool, true, "Should we use number of functions entered (repeats are counted) as a MAP-Elites axis?"),
  VALUE(USE_MAPE_AXIS__FUNC_ENTERED_ENTROPY, bool, true, "Should we use entropy of number of functions entered as a MAP-Elites axis?"),
